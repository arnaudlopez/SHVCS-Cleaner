...
.method public a(ILandroid/content/Context;Ljava/lang/String;)Landroid/content/Intent;
    ...
    invoke-static {p2}, La/a;->L(Landroid/content/Context;)Z
    ...
    :try_start_0
    invoke-static {p2}, LY2/b;->a(Landroid/content/Context;)LA1/p;
    ...
    iget-object p3, p3, LA1/p;->a:Landroid/content/Context;
...
.method public b(Landroid/content/Context;I)I
    ...
    sget-object v2, LQ2/f;->b:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :cond_0
    sget-object v2, LT2/o;->a:Ljava/lang/Object;

    monitor-enter v2

    :try_start_1
    sget-boolean v3, LT2/o;->b:Z
    ...
    :cond_1
    sput-boolean v0, LT2/o;->b:Z

    invoke-virtual {p1}, Landroid/content/Context;->getPackageName()Ljava/lang/String;

    move-result-object v3

    invoke-static {p1}, LY2/b;->a(Landroid/content/Context;)LA1/p;
    ...
    :try_start_2
    iget-object v4, v4, LA1/p;->a:Landroid/content/Context;
    ...
    sget-object v2, La/a;->f:Ljava/lang/Boolean;
    ...
    sput-object v2, La/a;->f:Ljava/lang/Boolean;
    ...
    const-class v8, LQ2/g;

    monitor-enter v8

    :try_start_9
    sget-object v9, LQ2/g;->e:LQ2/g;

    if-nez v9, :cond_c

    sget-object v9, LQ2/n;->a:LQ2/j;

    const-class v9, LQ2/n;
    ...
    :try_start_a
    sget-object v10, LQ2/n;->c:Landroid/content/Context;
    ...
    sput-object v10, LQ2/n;->c:Landroid/content/Context;
    :try_end_a
    ...
    invoke-direct {v9, v1}, LQ2/g;-><init>(I)V

    invoke-virtual {p1}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    sput-object v9, LQ2/g;->e:LQ2/g;
    :try_end_d
    ...
    invoke-static {v7}, LQ2/g;->z(Landroid/content/pm/PackageInfo;)Z
    ...
    invoke-static {v6}, LT2/o;->b(Ljava/lang/Object;)V

    invoke-static {v6}, LQ2/g;->z(Landroid/content/pm/PackageInfo;)Z
