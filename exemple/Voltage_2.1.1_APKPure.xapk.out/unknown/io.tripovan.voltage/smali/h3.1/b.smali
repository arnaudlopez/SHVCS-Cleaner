...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lh3/b;->a:LE/O;

    new-instance v0, LE/O;

    invoke-direct {v0, v1}, LE/O;-><init>(I)V

    iput-object v0, p0, Lh3/b;->b:LE/O;

    return-void
.end method

.method public static a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Lh3/b;
    .locals 1
    ...
    invoke-static {p0, p1}, Lh3/b;->b(Landroid/content/Context;I)Lh3/b;
...
.method public static b(Landroid/content/Context;I)Lh3/b;
    .locals 3
    ...
    invoke-static {p0}, Lh3/b;->c(Ljava/util/ArrayList;)Lh3/b;
    ...
    invoke-static {v1}, Lh3/b;->c(Ljava/util/ArrayList;)Lh3/b;
...
.method public static c(Ljava/util/ArrayList;)Lh3/b;
    .locals 13
    ...
    invoke-virtual {v0, v5, v6}, Lh3/b;->g(Ljava/lang/String;[Landroid/animation/PropertyValuesHolder;)V
    ...
    sget-object v11, Lh3/a;->d:LG1/a;

    goto :goto_2

    :cond_2
    :goto_1
    sget-object v11, Lh3/a;->b:LG1/a;

    :cond_3
    :goto_2
    invoke-direct {v6}, Ljava/lang/Object;-><init>()V

    iput v2, v6, Lh3/c;->d:I

    const/4 v12, 0x1

    iput v12, v6, Lh3/c;->e:I

    iput-wide v7, v6, Lh3/c;->a:J

    iput-wide v9, v6, Lh3/c;->b:J

    iput-object v11, v6, Lh3/c;->c:Landroid/animation/TimeInterpolator;

    invoke-virtual {v4}, Landroid/animation/ValueAnimator;->getRepeatCount()I

    move-result v7

    iput v7, v6, Lh3/c;->d:I

    invoke-virtual {v4}, Landroid/animation/ValueAnimator;->getRepeatMode()I

    move-result v4

    iput v4, v6, Lh3/c;->e:I

    iget-object v4, v0, Lh3/b;->a:LE/O;

    invoke-virtual {v4, v5, v6}, LE/O;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final d(Ljava/lang/String;Ljava/lang/Object;Landroid/util/Property;)Landroid/animation/ObjectAnimator;
    ...
    invoke-virtual {p0, p1}, Lh3/b;->e(Ljava/lang/String;)[Landroid/animation/PropertyValuesHolder;
    ...
    iget-object p3, p0, Lh3/b;->a:LE/O;

    invoke-virtual {p3, p1}, LE/O;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p1}, Lh3/c;->a()Landroid/animation/TimeInterpolator;

    move-result-object p3

    invoke-virtual {p2, p3}, Landroid/animation/Animator;->setInterpolator(Landroid/animation/TimeInterpolator;)V

    iget p3, p1, Lh3/c;->d:I
...
.method public final e(Ljava/lang/String;)[Landroid/animation/PropertyValuesHolder;
    ...
    invoke-virtual {p0, p1}, Lh3/b;->f(Ljava/lang/String;)Z

    move-result v0

    if-eqz v0, :cond_1

    iget-object v0, p0, Lh3/b;->b:LE/O;
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    iget-object v0, p0, Lh3/b;->a:LE/O;

    iget-object p1, p1, Lh3/b;->a:LE/O;

    invoke-virtual {v0, p1}, LE/O;->equals(Ljava/lang/Object;)Z
...
.method public final hashCode()I
    ...
    invoke-virtual {v0}, LE/O;->hashCode()I
...
.method public final toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lh3/b;->a:LE/O;
