...
.method public final b()V
    ...
    invoke-virtual {v3, v4, v5}, Lo1/W;->c(J)V

    :cond_2
    iget-object v4, p0, Ll/j;->c:Landroid/view/animation/BaseInterpolator;

    if-eqz v4, :cond_3

    iget-object v5, v3, Lo1/W;->a:Ljava/lang/ref/WeakReference;
    ...
    :cond_3
    iget-object v4, p0, Ll/j;->d:Landroid/support/v4/media/session/b;

    if-eqz v4, :cond_4

    iget-object v4, p0, Ll/j;->f:Ll/i;

    invoke-virtual {v3, v4}, Lo1/W;->d(Lo1/X;)V

    :cond_4
    iget-object v3, v3, Lo1/W;->a:Ljava/lang/ref/WeakReference;
