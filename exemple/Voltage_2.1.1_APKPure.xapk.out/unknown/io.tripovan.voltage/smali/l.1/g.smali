...
.method public final b(Landroid/view/MenuItem;)V
    ...
    iput-object v4, v0, Ll/f;->d:Ljava/lang/Object;
    ...
    :try_start_0
    sget-object v6, Ll/f;->f:[Ljava/lang/Class;

    invoke-virtual {v4, v5, v6}, Ljava/lang/Class;->getMethod(Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;

    move-result-object v6

    iput-object v6, v0, Ll/f;->e:Ljava/lang/reflect/Method;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {v1, v5, v2}, LA0/S;->s(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-virtual {v0, v3}, Lm/o;->f(Z)V
    ...
    iget-object v5, v0, Lm/t;->c:Li1/a;
    ...
    invoke-interface {v1, v0}, Li1/a;->a(Lm/p;)Li1/a;
    ...
    invoke-interface {v2, v0}, Li1/a;->setContentDescription(Ljava/lang/CharSequence;)Li1/a;

    goto :goto_7

    :cond_d
    invoke-static {p1, v0}, Lo1/k;->h(Landroid/view/MenuItem;Ljava/lang/CharSequence;)Landroid/view/MenuItem;
    ...
    invoke-interface {v2, v0}, Li1/a;->setTooltipText(Ljava/lang/CharSequence;)Li1/a;

    goto :goto_8

    :cond_e
    invoke-static {p1, v0}, Lo1/k;->m(Landroid/view/MenuItem;Ljava/lang/CharSequence;)Landroid/view/MenuItem;
    ...
    invoke-interface {v3, v0, v2}, Li1/a;->setAlphabeticShortcut(CI)Landroid/view/MenuItem;

    goto :goto_9

    :cond_f
    invoke-static {p1, v0, v2}, Lo1/k;->g(Landroid/view/MenuItem;CI)Landroid/view/MenuItem;
    ...
    invoke-interface {v3, v0, v2}, Li1/a;->setNumericShortcut(CI)Landroid/view/MenuItem;

    goto :goto_a

    :cond_10
    invoke-static {p1, v0, v2}, Lo1/k;->k(Landroid/view/MenuItem;CI)Landroid/view/MenuItem;
    ...
    invoke-interface {v2, v0}, Li1/a;->setIconTintMode(Landroid/graphics/PorterDuff$Mode;)Landroid/view/MenuItem;

    goto :goto_b

    :cond_11
    invoke-static {p1, v0}, Lo1/k;->j(Landroid/view/MenuItem;Landroid/graphics/PorterDuff$Mode;)Landroid/view/MenuItem;
    ...
    invoke-interface {p1, v0}, Li1/a;->setIconTintList(Landroid/content/res/ColorStateList;)Landroid/view/MenuItem;

    goto :goto_c

    :cond_13
    invoke-static {p1, v0}, Lo1/k;->i(Landroid/view/MenuItem;Landroid/content/res/ColorStateList;)Landroid/view/MenuItem;
