...
.method public a(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/media/session/b;->Z(I)V
...
.method public b(Lm/m;Z)V
    ...
    :cond_1
    iget-object v4, p0, Lh/s;->e:Lh/C;

    iget-object v5, v4, Lh/C;->O:[Lh/B;
    ...
    invoke-virtual {v4, p1, v7, v0}, Lh/C;->p(ILh/B;Lm/m;)V

    invoke-virtual {v4, v7, v2}, Lh/C;->r(Lh/B;Z)V

    goto :goto_3

    :cond_5
    invoke-virtual {v4, v7, p2}, Lh/C;->r(Lh/B;Z)V
    ...
    :pswitch_0
    iget-object p2, p0, Lh/s;->e:Lh/C;

    invoke-virtual {p2, p1}, Lh/C;->q(Lm/m;)V
...
.method public c(Lm/m;)Z
    ...
    iget-boolean v1, v0, Lh/C;->I:Z

    if-eqz v1, :cond_0

    iget-object v1, v0, Lh/C;->o:Landroid/view/Window;
...
.method public f()Z
    ...
    invoke-virtual {v0}, Landroid/support/v4/media/session/b;->y()I
...
.method public g()Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v0, v2, v1}, LA1/v;->F(Landroid/content/Context;Landroid/util/AttributeSet;[I)LA1/v;

    move-result-object v0

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, LA1/v;->t(I)Landroid/graphics/drawable/Drawable;
...
.method public h(Landroid/view/View;Lo1/t0;)Lo1/t0;
    ...
    iget-object v0, v5, Lh/C;->y:Landroidx/appcompat/widget/ActionBarContextView;
    ...
    iget-object v0, v5, Lh/C;->f0:Landroid/graphics/Rect;
    ...
    iput-object v0, v5, Lh/C;->f0:Landroid/graphics/Rect;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, v5, Lh/C;->g0:Landroid/graphics/Rect;

    :cond_0
    iget-object v12, v5, Lh/C;->f0:Landroid/graphics/Rect;

    iget-object v0, v5, Lh/C;->g0:Landroid/graphics/Rect;
    ...
    iget-object v8, v5, Lh/C;->D:Landroid/view/ViewGroup;
    ...
    iget-object v12, v5, Lh/C;->D:Landroid/view/ViewGroup;

    sget-object v13, Lo1/O;->a:Ljava/util/WeakHashMap;

    invoke-static {v12}, Lo1/D;->a(Landroid/view/View;)Lo1/t0;
    ...
    :goto_5
    iget-object v8, v5, Lh/C;->n:Landroid/content/Context;

    if-lez v0, :cond_8

    iget-object v0, v5, Lh/C;->F:Landroid/view/View;
    ...
    iput-object v0, v5, Lh/C;->F:Landroid/view/View;
    ...
    iget-object v13, v5, Lh/C;->F:Landroid/view/View;
    ...
    iget-object v9, v5, Lh/C;->F:Landroid/view/View;
    ...
    invoke-static {v8, v9}, Le1/b;->a(Landroid/content/Context;I)I
    ...
    iget-object v8, v5, Lh/C;->y:Landroidx/appcompat/widget/ActionBarContextView;
    ...
    :cond_12
    :goto_a
    iget-object v5, v5, Lh/C;->F:Landroid/view/View;
    ...
    invoke-direct {v7, v2}, Lo1/k0;-><init>(Lo1/t0;)V
    ...
    invoke-direct {v7, v2}, Lo1/j0;-><init>(Lo1/t0;)V
    ...
    invoke-direct {v7, v2}, Lo1/h0;-><init>(Lo1/t0;)V

    :goto_c
    invoke-static {v0, v6, v3, v5}, Lg1/c;->b(IIII)Lg1/c;

    move-result-object v0

    invoke-virtual {v7, v0}, Lo1/l0;->g(Lg1/c;)V
    ...
    invoke-virtual {v0}, Lo1/t0;->f()Landroid/view/WindowInsets;

    move-result-object v2

    if-eqz v2, :cond_18

    invoke-static {v1, v2}, Lo1/A;->b(Landroid/view/View;Landroid/view/WindowInsets;)Landroid/view/WindowInsets;
    ...
    invoke-static {v1, v3}, Lo1/t0;->g(Landroid/view/View;Landroid/view/WindowInsets;)Lo1/t0;
