...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v1, p0, Ln/P;->k:Landroid/graphics/Rect;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v1

    invoke-static {p0, v1}, Ln/R0;->a(Landroid/view/View;Landroid/content/Context;)V

    sget-object v1, Lg/a;->v:[I

    invoke-static {p1, p2, v1, v0}, LA1/v;->G(Landroid/content/Context;Landroid/util/AttributeSet;[II)LA1/v;

    move-result-object v2

    new-instance v3, LS1/b;

    invoke-direct {v3, p0}, LS1/b;-><init>(Landroid/view/View;)V

    iput-object v3, p0, Ln/P;->d:LS1/b;

    iget-object v3, v2, LA1/v;->f:Ljava/lang/Object;
    ...
    iput-object v6, p0, Ln/P;->e:Landroid/content/Context;

    goto :goto_0

    :cond_0
    iput-object p1, p0, Ln/P;->e:Landroid/content/Context;
    ...
    iget-object v9, p0, Ln/P;->e:Landroid/content/Context;

    invoke-direct {v4, p0, v9, p2}, Ln/M;-><init>(Ln/P;Landroid/content/Context;Landroid/util/AttributeSet;)V

    iget-object v9, p0, Ln/P;->e:Landroid/content/Context;

    invoke-static {v9, p2, v1, v0}, LA1/v;->G(Landroid/content/Context;Landroid/util/AttributeSet;[II)LA1/v;
    ...
    iget-object v11, v1, LA1/v;->f:Ljava/lang/Object;
    ...
    invoke-virtual {v1, v8}, LA1/v;->t(I)Landroid/graphics/drawable/Drawable;

    move-result-object v9

    invoke-virtual {v4, v9}, Ln/E0;->l(Landroid/graphics/drawable/Drawable;)V

    invoke-virtual {v3, v7}, Landroid/content/res/TypedArray;->getString(I)Ljava/lang/String;

    move-result-object v7

    iput-object v7, v4, Ln/M;->F:Ljava/lang/CharSequence;

    invoke-virtual {v1}, LA1/v;->J()V

    iput-object v4, p0, Ln/P;->i:Ln/O;

    new-instance v1, Ln/H;

    invoke-direct {v1, p0, p0, v4}, Ln/H;-><init>(Ln/P;Ln/P;Ln/M;)V

    iput-object v1, p0, Ln/P;->f:Ln/H;
    ...
    iput-object v1, p0, Ln/P;->i:Ln/O;

    invoke-virtual {v3, v7}, Landroid/content/res/TypedArray;->getString(I)Ljava/lang/String;

    move-result-object v4

    iput-object v4, v1, Ln/J;->f:Ljava/lang/CharSequence;
    ...
    :cond_5
    invoke-virtual {v2}, LA1/v;->J()V

    iput-boolean v8, p0, Ln/P;->h:Z

    iget-object p1, p0, Ln/P;->g:Landroid/widget/SpinnerAdapter;

    if-eqz p1, :cond_6

    invoke-virtual {p0, p1}, Ln/P;->setAdapter(Landroid/widget/SpinnerAdapter;)V

    iput-object v6, p0, Ln/P;->g:Landroid/widget/SpinnerAdapter;

    :cond_6
    iget-object p1, p0, Ln/P;->d:LS1/b;
...
.method public final a(Landroid/widget/SpinnerAdapter;Landroid/graphics/drawable/Drawable;)I
    ...
    iget-object p1, p0, Ln/P;->k:Landroid/graphics/Rect;
...
.method public final drawableStateChanged()V
    ...
    iget-object v0, p0, Ln/P;->d:LS1/b;
...
.method public getPopupBackground()Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0}, Ln/O;->g()Landroid/graphics/drawable/Drawable;
...
.method public getPopupContext()Landroid/content/Context;
    ...
    iget-object v0, p0, Ln/P;->e:Landroid/content/Context;
...
.method public getPrompt()Ljava/lang/CharSequence;
    ...
    invoke-interface {v0}, Ln/O;->h()Ljava/lang/CharSequence;
...
.method public final performClick()Z
    ...
    iget-object v2, p0, Ln/P;->i:Ln/O;

    invoke-interface {v2, v0, v1}, Ln/O;->e(II)V
...
.method public setAdapter(Landroid/widget/SpinnerAdapter;)V
    ...
    .line 3
    iput-object p1, p0, Ln/P;->g:Landroid/widget/SpinnerAdapter;
    ...
    .line 6
    iget-object v1, p0, Ln/P;->e:Landroid/content/Context;
    ...
    .line 15
    :cond_3
    invoke-interface {v0, v2}, Ln/O;->n(Landroid/widget/ListAdapter;)V
...
.method public setDropDownHorizontalOffset(I)V
    ...
    invoke-interface {v0, p1}, Ln/O;->o(I)V

    invoke-interface {v0, p1}, Ln/O;->b(I)V
...
.method public setDropDownVerticalOffset(I)V
    ...
    invoke-interface {v0, p1}, Ln/O;->m(I)V
...
.method public setPopupBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-interface {v0, p1}, Ln/O;->l(Landroid/graphics/drawable/Drawable;)V
...
.method public setPrompt(Ljava/lang/CharSequence;)V
    ...
    invoke-interface {v0, p1}, Ln/O;->j(Ljava/lang/CharSequence;)V
