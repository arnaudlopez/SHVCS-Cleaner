...
.method public static a(Landroid/view/DragEvent;Landroid/widget/TextView;Landroid/app/Activity;)Z
    ...
    invoke-direct {p2, p0, v1}, Landroidx/lifecycle/G;-><init>(Landroid/content/ClipData;I)V
    ...
    iput-object p0, p2, Lo1/d;->e:Landroid/content/ClipData;

    iput v1, p2, Lo1/d;->f:I

    :goto_0
    invoke-interface {p2}, Lo1/c;->d()Lo1/f;

    move-result-object p0

    invoke-static {p1, p0}, Lo1/O;->i(Landroid/view/View;Lo1/f;)Lo1/f;
    :try_end_0
